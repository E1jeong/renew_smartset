...
public abstract class I2C_Enabled_Commands {
     ...
     */
    public static I2C_Enabled_Commands get(Tag tag)
            throws IOException, InterruptedException {
        byte[] answer;
        byte[] command = new byte[2];
        NfcA nfca = NfcA.get(tag);
        Ntag_Get_Version.Prod prod;
        Log.v("I2C_CMD", "I2C_Enabled_Commands => get -  01");

        //yikim 2017.10.19 NFCA 일부기종에서 지원하지 않아 사용안함
    /*
		...
		if (nfca.getTimeout() < 50) {
			...
			try {
				...
				nfca.close();
				Log.v("I2C_CMD", "I2C_Enabled_Commands => get -  01-1");
				if (prod == Prod.NTAG_I2C_1k || prod == Prod.NTAG_I2C_2k
					...
					Log.v("I2C_CMD", "I2C_Enabled_Commands => get -  01-2");
				...
				Log.v("I2C_CMD", "I2C_Enabled_Commands => get -  01-3");
				...
				try {
					...
					answer = nfca.transceive(command);
					nfca.close();
					Log.v("I2C_CMD", "I2C_Enabled_Commands => get -  01-4");
					return new Ntag_I2C_Commands(tag);

				} catch (Exception e2) {
					e.printStackTrace();
					nfca.close();
					Log.v("I2C_CMD", "I2C_Enabled_Commands => get -  01-5");
				}
			}
		}
		Log.v("I2C_CMD", "I2C_Enabled_Commands => get -  02");
*/
        ...
        try {
            ...
            if (
                    prod == Ntag_Get_Version.Prod.NTAG_I2C_1k ||
                            ...
                            prod == Ntag_Get_Version.Prod.NTAG_I2C_1k_T ||
                            prod == Ntag_Get_Version.Prod.NTAG_I2C_2k_T ||
                            prod == Ntag_Get_Version.Prod.NTAG_I2C_1k_V ||
                            prod == Ntag_Get_Version.Prod.NTAG_I2C_2k_V ||
                            prod == Ntag_Get_Version.Prod.NTAG_I2C_1k_Plus ||
                            prod == Ntag_Get_Version.Prod.NTAG_I2C_2k_Plus
            ) {
                //Log.v("I2C_CMD", "I2C_Enabled_Commands => get -  02-2 prod:" + prod);
     ...
     */
    public abstract byte[] getSessionRegisters()
     ...
     * @throws CommandNotSupportedException
     */
    public abstract byte[] getConfigRegisters()
            throws IOException, FormatException, CommandNotSupportedException;
     ...
     * @throws CommandNotSupportedException
     */
    public abstract byte getConfigRegister(CR_Offset off)
            throws IOException, FormatException, CommandNotSupportedException;
     ...
     * @throws CommandNotSupportedException
     */
    public abstract byte getSessionRegister(SR_Offset off)
            throws IOException, FormatException, CommandNotSupportedException;
     ...
     * @throws CommandNotSupportedException
     */
    public abstract void writeConfigRegisters(
            byte NC_R,
            byte LD_R,
            byte SM_R,
            byte WD_LS_R,
     ...
     * @throws IOException
     */
    public abstract Boolean checkPTwritePossible()
     ...
     */
    public abstract void waitforI2Cwrite(int timeoutMS)
     ...
     * @throws TimeoutException
     */
    public abstract void waitforI2Cread(int timeoutMS)
            throws IOException, FormatException, TimeoutException;
     ...
     * @throws CommandNotSupportedException
     */
    public abstract void writeEEPROM(byte[] data)
            throws IOException, FormatException, CommandNotSupportedException;
     ...
     * @throws CommandNotSupportedException
     */
    public abstract void writeSRAMBlock(byte[] data)
            throws IOException, FormatException, CommandNotSupportedException;

    /**
     * Writes on SRAM Block Only 16 Bytes are transfered.
     *
     * @param data Data to write
     * @throws IOException
     * @throws FormatException
     * @throws CommandNotSupportedException
     */
    public abstract void fast_writeSRAMBlock(byte[] data)
            throws IOException, FormatException, CommandNotSupportedException;
     ...
     * @throws CommandNotSupportedException
     */
    public abstract byte[] readSRAMBlock()
            throws IOException, FormatException, CommandNotSupportedException;
     ...
     * @throws CommandNotSupportedException
     */
    public abstract byte[] fast_readSRAMBlock()
            throws IOException, FormatException, CommandNotSupportedException;
     ...
     */
    public abstract int writeDeliveryNdef()
     ...
     * @throws CommandNotSupportedException
     */
    public abstract void writeNDEF(NdefMessage message)
            throws IOException, FormatException, CommandNotSupportedException;
     ...
     */
    public abstract byte[] authenticatePlus(byte[] pwd)
     ...
     *
     * @param pwd       4Byte password to authenticate with
     * @param startAddr Page to lock the memory from
     * @throws IOException
     * @throws FormatException
     */
    public abstract void protectPlus(byte[] pwd, byte startAddr)
     ...
     * @throws NotPlusTagException
     */
    public abstract void unprotectPlus()
            throws IOException, FormatException, NotPlusTagException;
     ...
     * @throws CommandNotSupportedException
     */
    public abstract byte[] getAccessRegister()
            throws IOException, FormatException, CommandNotSupportedException;
     ...
     * @throws CommandNotSupportedException
     */
    public abstract byte[] getPTI2CRegister()
            throws IOException, FormatException, CommandNotSupportedException;
     ...
     * @throws CommandNotSupportedException
     */
    public abstract byte[] getAuth0Register()
            throws IOException, FormatException, CommandNotSupportedException;
     ...
     * @throws CommandNotSupportedException
     */
    public abstract void writeAuthRegisters(byte auth0, byte access, byte pt_i2c)
            throws IOException, FormatException, CommandNotSupportedException;
     ...
     * @throws CommandNotSupportedException
     */
    public abstract NdefMessage readNDEF()
            throws IOException, FormatException, CommandNotSupportedException;
    ...
    public enum NS_Reg_Func {
        RF_FIELD_PRESENT((byte) (0x01 << 0)),
        EEPROM_WR_BUSY((byte) (0x01 << 1)),
        EEPROM_WR_ERR((byte) (0x01 << 2)),
        SRAM_RF_READY((byte) (0x01 << 3)),
        SRAM_I2C_READY((byte) (0x01 << 4)),
        RF_LOCKED((byte) (0x01 << 5)),
        I2C_LOCKED((byte) (0x01 << 6)),
        NDEF_DATA_READ((byte) (0x01 << 7));
    ...
    public enum NC_Reg_Func {
        PTHRU_DIR((byte) (0x01 << 0)),
        SRAM_MIRROR_ON_OFF((byte) (0x01 << 1)),
        FD_ON((byte) (0x03 << 2)),
        FD_OFF((byte) (0x03 << 4)),
        PTHRU_ON_OFF((byte) (0x01 << 6)),
        I2C_RST_ON_OFF((byte) (0x01 << 7));
