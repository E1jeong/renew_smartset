...
public class Ntag_Get_Version {
    ...
    static {
        NTAG_I2C_1k =
                new Ntag_Get_Version(
                        new byte[]{0x00, 0x04, 0x04, 0x05, 0x01, 0x01, 0x13, 0x03}
                );
        NTAG_I2C_2k =
                new Ntag_Get_Version(
                        new byte[]{0x00, 0x04, 0x04, 0x05, 0x01, 0x01, 0x15, 0x03}
                );

        NTAG_I2C_1k_V =
                new Ntag_Get_Version(
                        new byte[]{0x00, 0x04, 0x04, 0x05, 0x02, 0x00, 0x13, 0x03}
                );
        NTAG_I2C_2k_V =
                new Ntag_Get_Version(
                        new byte[]{0x00, 0x04, 0x04, 0x05, 0x02, 0x00, 0x15, 0x03}
                );

        NTAG_I2C_1k_T =
                new Ntag_Get_Version(
                        new byte[]{0x00, 0x04, 0x04, 0x05, 0x02, 0x01, 0x13, 0x03}
                );
        NTAG_I2C_2k_T =
                new Ntag_Get_Version(
                        new byte[]{0x00, 0x04, 0x04, 0x05, 0x02, 0x01, 0x15, 0x03}
                );

        NTAG_I2C_1k_Plus =
                new Ntag_Get_Version(
                        new byte[]{0x00, 0x04, 0x04, 0x05, 0x02, 0x02, 0x13, 0x03}
                );
        NTAG_I2C_2k_Plus =
                new Ntag_Get_Version(
                        new byte[]{0x00, 0x04, 0x04, 0x05, 0x02, 0x02, 0x15, 0x03}
                );

        MTAG_I2C_1k =
                new Ntag_Get_Version(
                        new byte[]{0x00, 0x04, 0x05, 0x07, 0x02, 0x02, 0x13, 0x03}
                );
        MTAG_I2C_2k =
                new Ntag_Get_Version(
                        new byte[]{0x00, 0x04, 0x05, 0x07, 0x02, 0x02, 0x15, 0x03}
                );

        TNPI_6230 =
                new Ntag_Get_Version(
                        new byte[]{0x00, 0x04, 0x05, 0x05, 0x01, 0x01, 0x15, 0x03}
                );
        TNPI_3230 =
                new Ntag_Get_Version(
                        new byte[]{0x00, 0x04, 0x05, 0x05, 0x01, 0x01, 0x13, 0x03}
                );
    }
     ...
     * Constructor.
     *
     * @param Data Data from the Get Version Command
     */
    ...
    public Prod Get_Product() {
        if (this.equals(NTAG_I2C_1k)) return Prod.NTAG_I2C_1k;
        if (this.equals(NTAG_I2C_2k)) return Prod.NTAG_I2C_2k;
        if (this.equals(NTAG_I2C_1k_T)) return Prod.NTAG_I2C_1k;
        if (this.equals(NTAG_I2C_2k_T)) return Prod.NTAG_I2C_2k;
        if (this.equals(NTAG_I2C_1k_V)) return Prod.NTAG_I2C_1k;
        if (this.equals(NTAG_I2C_2k_V)) return Prod.NTAG_I2C_2k;
        if (this.equals(NTAG_I2C_1k_Plus)) return Prod.NTAG_I2C_1k_Plus;
        if (this.equals(NTAG_I2C_2k_Plus)) return Prod.NTAG_I2C_2k_Plus;
        if (this.equals(MTAG_I2C_1k)) return Prod.MTAG_I2C_1k;
        if (
                this.equals(MTAG_I2C_2k)
        ) return Prod.MTAG_I2C_2k;
        else return Prod.Unknown;
    }
