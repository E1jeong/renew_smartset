...
public class SmartMeterValveControl extends NfcTxMessage {
    public SmartMeterValveControl(int nControl) {
        ...
        hexData[m_nOffset++] = (byte) NfcConstant.METER_SEND_VALVE_CONTROL_SET; //C Field
        hexData[m_nOffset++] = (byte) 0x01; //A Field

        hexData[m_nOffset++] = (byte) nControl;
