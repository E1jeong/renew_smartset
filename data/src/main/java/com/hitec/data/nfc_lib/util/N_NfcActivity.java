...
import com.hitec.data.nfc_lib.protocol.recv.RxHeader;
import com.hitec.data.nfc_lib.protocol.send.AccountNoSet;
import com.hitec.data.nfc_lib.protocol.send.BdControlReq;
import com.hitec.data.nfc_lib.protocol.send.ChangeMinuteIntervalReq;
import com.hitec.data.nfc_lib.protocol.send.CheckSubTerm;
import com.hitec.data.nfc_lib.protocol.send.DeviceInfoReq;
import com.hitec.data.nfc_lib.protocol.send.DisplayConfSet;
import com.hitec.data.nfc_lib.protocol.send.FlashDataReq;
import com.hitec.data.nfc_lib.protocol.send.FlashDateListReq;
import com.hitec.data.nfc_lib.protocol.send.FwUpdateReq;
import com.hitec.data.nfc_lib.protocol.send.GsmChangeDomainReq;
import com.hitec.data.nfc_lib.protocol.send.LoraAppEuiKeyReq;
import com.hitec.data.nfc_lib.protocol.send.LoraAppEuiKeySet;
import com.hitec.data.nfc_lib.protocol.send.LoraConfSet;
import com.hitec.data.nfc_lib.protocol.send.MeterReq;
import com.hitec.data.nfc_lib.protocol.send.NbConfSet;
import com.hitec.data.nfc_lib.protocol.send.NbIdReq;
import com.hitec.data.nfc_lib.protocol.send.NbIdSet;
import com.hitec.data.nfc_lib.protocol.send.NfcTxMessage;
import com.hitec.data.nfc_lib.protocol.send.NodeConfReq;
import com.hitec.data.nfc_lib.protocol.send.PeriodMeterAck;
import com.hitec.data.nfc_lib.protocol.send.PeriodMeterReq;
import com.hitec.data.nfc_lib.protocol.send.SelectGsmOrLteReq;
import com.hitec.data.nfc_lib.protocol.send.ServerConnectReq;
import com.hitec.data.nfc_lib.protocol.send.SetTimeInfo;
import com.hitec.data.nfc_lib.protocol.send.SmartCertiCalibrationReq;
import com.hitec.data.nfc_lib.protocol.send.SmartCertiCalibrationSet;
import com.hitec.data.nfc_lib.protocol.send.SmartConfAutoStart;
import com.hitec.data.nfc_lib.protocol.send.SmartConfMeterReq;
import com.hitec.data.nfc_lib.protocol.send.SmartConfReq;
import com.hitec.data.nfc_lib.protocol.send.SmartConfSet;
import com.hitec.data.nfc_lib.protocol.send.SmartMeterReq;
import com.hitec.data.nfc_lib.protocol.send.SmartMeterValueSet;
import com.hitec.data.nfc_lib.protocol.send.SmartMeterValveControl;
import com.hitec.data.nfc_lib.protocol.send.SmartUltraCompSet;
import com.hitec.data.nfc_lib.protocol.send.SnChangeReq;
import com.hitec.data.nfc_lib.protocol.send.TxHeader;
import com.hitec.data.nfc_lib.reader.Ntag_Auth.AuthStatus;
import com.hitec.data.nfc_lib.reader.Ntag_Auth.Pwds;
import com.hitec.data.nfc_lib.reader.Ntag_I2C_Connect;

class N_MeterConfigT {

    String meterUtiltyNum;
    String meterUtiltyName;
    String meterTypeNum;
    String meterTypeName;
    String meterCompanyNum;
    String meterCompanyName;
    String meterPortNum;
    String meterPortName;
}
...
class N_AmiBufferData {
    ...
    int nMeterConfResult;
    String strMeterConfResult;
    int nAutoMode;
    int nAutoQnSelect;
    int nAutoErrorCode;
    boolean meterValueValid;
    String meterValue;
    String meterIntervalTime;
    String meterBaseTime;
    String reportIntervalTime;
    String reportRangeTime;
    String meterAlertTime;
    String meterPeriodTime;
    String meterBaseDay;
    String meterStoreMonth;
    String activeStartDay;
    String activeEndDay;
    String activeStartHour;
    String activeEndHour;
    String subUpdateInterval;
    String subNum;
    String subNwkID;
    int gsmlteMode;
    String meterCount;
    N_MeterConfigT stMeterConfig0;
    N_MeterValueT stMeterValue0;
    N_MeterConfigT stMeterConfig1;
    N_MeterValueT stMeterValue1;
    N_MeterConfigT stMeterConfig2;
    N_MeterValueT stMeterValue2;
}
...
public class N_NfcActivity extends Activity implements Constanse, ConstDB, ConstMeter, ConstCommon, ConstNfc {
    ...
    public void startNfcActivity(Activity act, Context cont, int nNfcType) {
        ...
        N_NfcActivity.setPassword(Pwds.PWD0.getValue());
  ...
  */
    ...
    public void doProcess(Intent nfc_intent) {
        ...
        setPassword(Pwds.PWD0.getValue());
        m_fNfcConnect = false;
        //@@ NFC Tag와 I2C 통신 수행
...
//      );
    ...
    private void connectNfc() {
        ...
        if (N_NfcActivity.getAuthStatus() == AuthStatus.Authenticated.getValue()) {
            Log.i("NFC_TEST", "connectNfc - 02");
            mNtagConnect.Auth(N_NfcActivity.getPassword(), AuthStatus.Protected_RW.getValue());
        }
