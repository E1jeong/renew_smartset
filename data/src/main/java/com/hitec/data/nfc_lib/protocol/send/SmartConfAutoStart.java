...
public class SmartConfAutoStart extends NfcTxMessage {

    public SmartConfAutoStart(
            int nFlowType,
        ...
        hexData[m_nOffset++] = (byte) NfcConstant.METER_SEND_CONF_AUTO_START; //C Field
        hexData[m_nOffset++] = (byte) 0x01; //A Field

        hexData[m_nOffset++] = (byte) nCompMode;
        hexData[m_nOffset++] = (byte) nCompSelect;
        DevUtil.convInt16ToByte(nQnFlow, hexData, m_nOffset);
        m_nOffset += 2;
