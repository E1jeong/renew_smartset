...
data class DownloadInstallDbResponse(
    ...
    @Element(name = "InstallDBInfo") val installDBInfo: List<InstallDbInfo>,
)
...
data class InstallDbInfo(
    ...
    @PropertyElement(name = "localSite") val localSite: String,
    @PropertyElement(name = "areaCd") val areaCd: String?,
    @PropertyElement(name = "siteUrl") val siteUrl: String,
)
